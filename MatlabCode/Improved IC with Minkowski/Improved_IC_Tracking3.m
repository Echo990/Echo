...
x_r = t;
y_r = sin(0.1*x_r);
Theta_r = cos(0.1*x_r);% geometry
Theta_r = acos(Theta_r);
% Plot the trajectory
...
subplot 311
stairs(t(1:N-1),x_record(1,1:N-1),'b','linewidth',2);
hold on
stairs(t,x_r,'r','linewidth',2);
hold off
xlabel('t')
ylabel('x')
legend('x','x_r')
subplot 312
stairs(t(1:N-1),x_record(2,1:N-1),'b','LineWidth',2);
hold on
stairs(t,y_r,'r','linewidth',2);
hold off
xlabel('t')
ylabel('y')
legend('y','y_r')
subplot 313
stairs(t(1:N-1),x_record(3,1:N-1),'b','LineWidth',2);
hold on
stairs(t,Theta_r,'r','linewidth',2);
hold off
xlabel('t')
ylabel('Theta')
